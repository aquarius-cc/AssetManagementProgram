...
> **版本**：v2.9.39 | **最后更新**：2026-09-22 | **性质**：动态账本，取代 v1.0 静态清单
>
...
- **边界声明**：destroy 硬删 vs 批量软删不对称（broken/lost/found destroy 走 `core/mixins.py::ResponseWrapperMixin.destroy` 物理删除）由批次②a 处理（见 v2.9.40 预留）；本批只收口 Service/批量语义的 user 作用域。
